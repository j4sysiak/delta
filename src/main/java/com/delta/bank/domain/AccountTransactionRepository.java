...
public interface AccountTransactionRepository extends JpaRepository<AccountTransactionEntity, Long> {
    ...
    * */
    ...
    Page<AccountTransactionEntity> findByAccountNumberAndTypeOrderByCreatedAtDesc(
            String accountNumber,
            TransactionType type,
            Pageable pageable
    );

    Page<AccountTransactionEntity> findByAccountNumberAndCreatedAtBetweenOrderByCreatedAtDesc(
            String accountNumber,
            LocalDateTime from,
            LocalDateTime to,
            Pageable pageable
    ...
    Page<AccountTransactionEntity> findByAccountNumberAndTypeAndCreatedAtBetweenOrderByCreatedAtDesc(
            String accountNumber,
            TransactionType type,
            LocalDateTime from,
            LocalDateTime to,
    ...
    Page<AccountTransactionEntity> findByAccountNumberAndAmountBetweenOrderByCreatedAtDesc(
            String accountNumber,
    ...
    Page<AccountTransactionEntity> findByAccountNumberAndTypeAndAmountBetweenOrderByCreatedAtDesc(
            String accountNumber,
            TransactionType type,
            BigDecimal minAmount,
            BigDecimal maxAmount,
    ...
    Page<AccountTransactionEntity> findByAccountNumberAndCreatedAtBetweenAndAmountBetweenOrderByCreatedAtDesc(
            String accountNumber,
            LocalDateTime from,
            LocalDateTime to,
            BigDecimal minAmount,
    ...
    Page<AccountTransactionEntity> findByAccountNumberAndTypeAndCreatedAtBetweenAndAmountBetweenOrderByCreatedAtDesc(
            String accountNumber,
            TransactionType type,
            LocalDateTime from,
            LocalDateTime to,
    ...
    Optional<AccountTransactionEntity> findFirstByTransferRequestIdAndAccountNumberAndType(
